...
<?php if($data!=""): ?>
            ...
            <?php /*<a  style="float:left"onclick="javascript:printDiv('print')" class="md-btn   md-btn-success">Click to print form</a>*/ ?>
            ...
            <div id="print">
                ...
                <table>
                    <tr>
                        <td><img style="width:1000px;height: auto" src='<?php echo e(url("public/assets/img/qualityassurance.jpg")); ?>'
                    ...
                    <div class="footer">
                        <img style="width:1000px;height: auto" src='<?php echo e(url("public/assets/img/footer.jpg")); ?>' style=""
