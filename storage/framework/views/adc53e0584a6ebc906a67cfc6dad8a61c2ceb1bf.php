            ...
            <ul id="menu_top" class="uk-clearfix">
                ...
                <?php if( @Auth::user()->department=='Finance' || @Auth::user()->department=='top'): ?>
                    ...
                    <li data-uk-dropdown class="uk-hidden-small">
                        ...
                        <div class="uk-dropdown uk-dropdown-scrollable">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href='<?php echo url("/transcript"); ?>'>Transcript</a></li>
                                <li><a href='<?php echo url("pay_fees"); ?>'>Pay Fees</a></li>
                ...
                <?php else: ?>
                    <?php if(@Auth::user()->department=='Planning' ): ?>
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            ...
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    <li><a href='<?php echo url("/transcript"); ?>' target="_blank">Transcript</a></li>
                                    <li><a href='<?php echo url("/programmes"); ?>'>View Programmes</a></li>
                                    <li><a href='<?php echo url("staff"); ?>'>View Staff</a></li>
                    ...
                    <?php if( @Auth::user()->role=='Support' || @Auth::user()->role=='Registrar'): ?>
