            ...
            $excel->sheet('RSA', function ($sheet) use ($data,$kojoSense,$kojoSen2,$program,$year,$programme,$dpt3,$fac3,$lectname) 
                {
                    ...
                    //  Raw score format begins here
                        ...
                        for($k=2;$k<$kojoSense+1;$k++)
                            ...
                            $sheet->setCellValue('K'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('L'.$k.'','=COUNTIFS(TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('M'.$k.'','=SUMIFS(TP!G8:TP!G'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('N'.$k.'','=M'.$k.'/L'.$k);

                            $sheet->setCellValue('O'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('P'.$k.'','=COUNTIFS(TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('Q'.$k.'','=SUMIFS(TP!G8:TP!G'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"200")');
                            ...
                            for($lisa=1;$lisa<6;$lisa++)
                                {
                                $sheet->mergeCells('C'.$lisa.':J'.$lisa);
                    ...
                    $sheet->setWidth(array(
                        ...
                        $sheet->prependRow(1, array('prepended', 'prepended', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'GPA', 'CGPA', 'CR', 'GP', 'CGPA', 'REMARKS'));
                        ...
                        for($k=2;$k<$kojoSense+1;$k++)
                            ...
                            $sheet->setCellValue('D'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"100")');

                            

                            $sheet->setCellValue('E'.$k.'','=D'.$k.'/C'.$k);

                            $sheet->setCellValue('F'.$k.'','=D'.$k.'/C'.$k);

                            $sheet->setCellValue('G'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"100")');

                            $sheet->setCellValue('H'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"100")');

                            $sheet->setCellValue('I'.$k.'','=H'.$k.'/G'.$k);

                            $sheet->setCellValue('J'.$k.'','=(H'.$k.'+D'.$k.')/(G'.$k.'+C'.$k.')');

                            $sheet->setCellValue('K'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('L'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('M'.$k.'','=L'.$k.'/K'.$k);

                            $sheet->setCellValue('N'.$k.'','=(H'.$k.'+D'.$k.'+L'.$k.')/(G'.$k.'+C'.$k.'+K'.$k.')');
                            
                            $sheet->setCellValue('O'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('P'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"200")');

                            $sheet->setCellValue('Q'.$k.'','=P'.$k.'/O'.$k);

                            $sheet->setCellValue('R'.$k.'','=(H'.$k.'+D'.$k.'+L'.$k.'+P'.$k.')/(G'.$k.'+C'.$k.'+K'.$k.'+O'.$k.')');

                            $sheet->setCellValue('S'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"300")');

                            $sheet->setCellValue('T'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',1,TP!L8:TP!L'.$kojoSen2.',"300")');

                            $sheet->setCellValue('U'.$k.'','=T'.$k.'/S'.$k);

                            $sheet->setCellValue('V'.$k.'','=(H'.$k.'+D'.$k.'+L'.$k.'+P'.$k.'+T'.$k.')/(G'.$k.'+C'.$k.'+K'.$k.'+O'.$k.'+S'.$k.')');

                            $sheet->setCellValue('W'.$k.'','=SUMIFS(TP!D8:TP!D'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"300")');

                            $sheet->setCellValue('X'.$k.'','=SUMIFS(TP!I8:TP!I'.$kojoSen2.',TP!F8:TP!F'.$kojoSen2.',A'.$k.',TP!K8:TP!K'.$kojoSen2.',2,TP!L8:TP!L'.$kojoSen2.',"300")');

                            $sheet->setCellValue('Y'.$k.'','=X'.$k.'/W'.$k);

                            $sheet->setCellValue('Z'.$k.'','=(H'.$k.'+D'.$k.'+L'.$k.'+P'.$k.'+T'.$k.'+X'.$k.')/(G'.$k.'+C'.$k.'+K'.$k.'+O'.$k.'+S'.$k.'+W'.$k.')');

                            $sheet->setCellValue('AA'.$k.'','=C'.$k.'+G'.$k.'+K'.$k.'+O'.$k.'+S'.$k.'+W'.$k);

                            $sheet->setCellValue('AB'.$k.'','=D'.$k.'+H'.$k.'+L'.$k.'+P'.$k.'+T'.$k.'+X'.$k);

                            $sheet->setCellValue('AC'.$k.'','=AB'.$k.'/AA'.$k);
                            

                            $sheet->setCellValue('AD'.$k.'','=IF(AC'.$k.'>5,"",IF(AC'.$k.'>=4,"First Class",IF(AC'.$k.'>=3,"Second Class Upper",IF(AC'.$k.'>=2,"Second Class Lower",IF(AC'.$k.'>=1.5,"Pass",IF(AC'.$k.'<1.5,"Fail",""))))))');
...
$courseMACS1 = Models\MountedCourseModel::join('tpoly_courses','tpoly_courses.COURSE_CODE', '=', 'tpoly_mounted_courses.COURSE_CODE')->where('tpoly_mounted_courses.COURSE_YEAR', $yearcc)
                ...
                ->select('tpoly_courses.COURSE_NAME', 'tpoly_mounted_courses.COURSE_CODE','tpoly_mounted_courses.COURSE_SEMESTER', 'tpoly_mounted_courses.COURSE_LEVEL')
                ->get();
...
$datafuck = Models\AcademicRecordsModel::where("programme", $program)
        ...
        $explode_fuck = array_map('strval', explode(',',$fuck));
            ...
            #excel for headers
            @$excel->sheet('MACS', function ($sheet) use ($data,$courseMACS1,$kojoSense,$fuck,$fuckcount,$fucksem1,$fucksem2,$fucksem3,$fucksem4,$fucksem5,$fucksem11,$fucksem21,$fucksem31,$fucksem41,$fucksem51,$explode_fuck,$kojoSen2,$program,$year,$programme,$dpt3,$fac3,$lectname, $preyear) 
                {
                        ...
                        for($k=2;$k<$kojoSense+1;$k++)
                            ...
                            $sheet->setCellValue(''.$alpha.$k.'','=VLOOKUP('.$alpha.'$7&$A'.$k.',TP!$U$8:TP!$V$'.$kojoSen2.',2,FALSE)');
               ...
               //   # code...
                         $a = $value->course->COURSE_NAME;
                         $b= $value->course->COURSE_CODE;
                         $c= $value->course->COURSE_SEMESTER;
                         $d= $value->course->COURSE_LEVEL;
                         $g= $value->course->COURSE_CREDIT;
...
$datafuck = Models\AcademicRecordsModel::where("programme", $program)
        ...
        $explode_fuck = array_map('strval', explode(',',$fuck));
            ...
            #excel for headers
            @$excel->sheet('FAYLE', function ($sheet) use ($data,$courseMACS1,$kojoSense,$fuck,$fuckcount,$fucksem1,$fucksem2,$fucksem3,$fucksem4,$fucksem5,$fucksem11,$fucksem21,$fucksem31,$fucksem41,$fucksem51,$explode_fuck,$kojoSen2,$program,$year,$programme,$dpt3,$fac3,$lectname, $preyear) 
                {
...
$courseMACS1 = Models\MountedCourseModel::join('tpoly_courses','tpoly_courses.COURSE_CODE', '=', 'tpoly_mounted_courses.COURSE_CODE')->join('users','tpoly_mounted_courses.LECTURER', '=', 'users.fund')->where('tpoly_mounted_courses.COURSE_YEAR', $yearcc)
                ...
                ->orderBy('tpoly_mounted_courses.COURSE_CODE')
                ->groupBY('tpoly_mounted_courses.COURSE_CODE')
                ->select('tpoly_courses.COURSE_NAME', 'tpoly_mounted_courses.COURSE_CODE','tpoly_mounted_courses.COURSE_SEMESTER', 'tpoly_mounted_courses.COURSE_LEVEL', 'users.name')
                ->get();
...
$datafuck = Models\AcademicRecordsModel::where("programme", $program)
        ...
        $explode_fuck = array_map('strval', explode(',',$fuck));
            ...
            #excel for headers
            @$excel->sheet('KORCES', function ($sheet) use ($data,$courseMACS1,$kojoSense,$fuck,$fuckcount,$fucksem1,$fucksem2,$fucksem3,$fucksem4,$fucksem5,$fucksem11,$fucksem21,$fucksem31,$fucksem41,$fucksem51,$explode_fuck,$kojoSen2,$program,$year,$programme,$dpt3,$fac3,$lectname, $preyear) 
                {
               ...
               //   # code...
                        ...
                        if ($preyear > 2) {
                         ...
                         if ($preyear > 5) {                            
                            ...
                            //$sheet->mergeCells('K6:N6');
                            @$sheet->setCellValue('A7',' '.' '.'SEMESTER 1');
                            $k_fuck0d = 7 + $k_fuck1g + 2;
                            @$sheet->setCellValue('A'.$k_fuck0d.'',' '.' '.'Courses = '.$k_fuck1g.' // Credit Hours = '.$g1);

                             if ($preyear > 0) {
                            $k_fuck1d = $k_fuck1d + 9;
                            @$sheet->setCellValue('A'.$k_fuck1d.'',' '.' '.'SEMESTER 2');
                            $k_fuck1d = $k_fuck1d + $k_fuck2g + 2;
                            @$sheet->setCellValue('A'.$k_fuck1d.'',' '.' '.'Courses = '.$k_fuck2g.' // Credit Hours = '.$g2);
                            } 
                            if ($preyear > 1) {
                            $k_fuck2d = $k_fuck2d + 9;
                            @$sheet->setCellValue('A'.$k_fuck2d.'',' '.' '.'SEMESTER 3');
                            $k_fuck2d = $k_fuck2d + $k_fuck3g + 2;
                            @$sheet->setCellValue('A'.$k_fuck2d.'',' '.' '.'Courses = '.$k_fuck3g.' // Credit Hours = '.$g3);
                            } 
                            if ($preyear > 2) {
                            $k_fuck3d = $k_fuck3d + 9;
                            @$sheet->setCellValue('A'.$k_fuck3d.'',' '.' '.'SEMESTER 4');
                            $k_fuck3d = $k_fuck3d + $k_fuck4g + 2;
                            @$sheet->setCellValue('A'.$k_fuck3d.'',' '.' '.'Courses = '.$k_fuck4g.' // Credit Hours = '.$g4);
                            } 
                            if ($preyear > 3) {
                            $k_fuck4d = $k_fuck4d + 9;
                            @$sheet->setCellValue('A'.$k_fuck4d.'',' '.' '.'SEMESTER 5');
                            $k_fuck4d = $k_fuck4d + $k_fuck5g + 2;
                            @$sheet->setCellValue('A'.$k_fuck4d.'',' '.' '.'Courses = '.$k_fuck5g.' // Credit Hours = '.$g5);
                            } 
                            if ($preyear > 4) {
                            $k_fuck5d = $k_fuck5d + 9;
                            @$sheet->setCellValue('A'.$k_fuck5d.'',' '.' '.'SEMESTER 6');
                            $k_fuck5d = $k_fuck5d + $k_fuck6g + 2;
                            @$sheet->setCellValue('A'.$k_fuck5d.'',' '.' '.'Courses = '.$k_fuck6g.' // Credit Hours = '.$g6);
                            } 
