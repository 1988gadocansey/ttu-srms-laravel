            ...
            <div id='page1'>
                        ...
                        <div class="content" id="technical">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <hr>
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of Higher National Diploma in<b> {{$sys->getProgram($data->PROGRAMME_ADMITTED)}}</b>. The duration of the programme is {{$sys->getProgramDuration($data->PROGRAMME_ADMITTED)}} Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                ...
                                <p>2. The<b> {{$year}} academic year</b> is scheduled to begin on <b> Monday 28th August   {{date('Y')}}</b>. You are however expected to report for medical examination and registration from <b>Monday 28th August {{date('Y')}} to Friday 8th September  {{date('Y')}}</b>.You are mandated to participate in orientation programme which will run from <b>Monday 4th September to Friday 8th September {{date('Y')}}</b>.</p>
                                 ...
                                 <p>3. You are required to make full payment of <b>non-refundable fee </b> of <b>GHS{{ $data->ADMISSION_FEES}}</b> at any branch of <b>{{strtoupper($data->admitedProgram->department->schools->banks->NAME)}} into Account Number {{$data->admitedProgram->department->schools->banks->ACCOUNT_NUMBER}}</b>. If you do not indicate acceptance by paying the fees before <b> Friday 30th June,{{date('Y')}}</b> your place will be offered to another applicant on the waiting list. You are advised to make photocopy of the Pay-in-slip for keeps and present the original to the School Accounts Office on arrival.Indicate your admission number and programme of study on the Pay-in-slip. Any Applicant who fails to make full payment of fees forfeit his/her admission. <b>Note: Fee payment is for an Academic Year</b>.</p>
                          ...
                          @if($data->RESIDENTIAL_STATUS==0) 
                           ...
                           <td>
                               ...
                               <p><img src='{{url("public/assets/img/signature.JPG")}}' style="width:90px;height:auto;" /></p>
                        ...
                        <div class="content" id="provisional">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <hr>
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of Higher National Diploma in<b> {{$sys->getProgram($data->PROGRAMME_ADMITTED)}}</b>. The duration of the programme is {{$sys->getProgramDuration($data->PROGRAMME_ADMITTED)}} Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                <p><i>Note: Your admission is <b>PROVISIONAL</b>, you are therefore, required to present your results to the university’s admissions office after it is published, to enable the office regularlised your admission.</i></p>
                           ...
                           @else
                            <p>10. You have been given Hall Accommodation in<b> {{strtoupper($data->HALL_ADMITTED)}} Hall </b>. You are to pay GHS{{$sys->hallFees($data->HALL_ADMITTED)}} into any branch of Zenith Bank Ghana with account number  {{$sys->hallAccount($data->HALL_ADMITTED)}} </p>
                            @endif
                            <p>11. Any applicant who falsified results will be withdrawn from the university and will forfeit his/her fees paid.</p>
                            <p>You are required to make the payment before or on Friday 30th June {{date('Y')}}. </p>
                        ...
                        <div class="content" id="conditional">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of Higher National Diploma in<b> {{$sys->getProgram($data->PROGRAMME_ADMITTED)}}</b>. The duration of the programme is {{$sys->getProgramDuration($data->PROGRAMME_ADMITTED)}} Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                <p><i>
                                    Note: Your admission is conditional. Per the new requirements you are supposed to have a minimum of D7 in six subjects with at least C6 in three relevant subjects in the area of specialization. You are therefore required to rewrite to make good the deficiencies within a period of one academic year. Your eligibility to continue with the HND programme would be based on the outcome of the SSCE/WASSCE result. You would be required to present your new results in writing to the DEPUTY REGISTRAR Academic affairs.
