                ...
                <form    method="post" accept-charset="utf-8" name="applicationForm"  v-form >
                   {!!  csrf_field()  !!}
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                   <select placeholder='type courses' class="md-input course"  name="course"  >
                                           <option selected="">type course name here</option>
                                           @foreach($course as $item)
                                        
                                          <option value="{{$item->COURSE_CODE}}">{{$item->COURSE_NAME}} ( {{$sys->getProgramName($item->PROGRAMME)}} {{ $item->COURSE_LEVEL }}/{{$item->COURSE_SEMESTER}}sem)</option>
                                        @endforeach
                                      </select>
                   ...
                   <center>
                       <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">                            
                                ...
                                <button  v-show="applicationForm.$valid"  class="md-btn   md-btn-small md-btn-danger uk-margin-small-top action" type="button">Delete</button> 
