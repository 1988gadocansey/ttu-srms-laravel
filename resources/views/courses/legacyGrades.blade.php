...
@if(Session::has('success'))
 ...
 @endif
 <h3 class="heading_c uk-margin-bottom">Upload Legacy Grades (CSV file format only) <a href="{{url('public/uploads/marks/mark.csv')}}">Click to download sample upload template</a></h3>
...
<div class="uk-width-xLarge-1-10">
    ...
    <div class="md-card">
        <div class="md-card-content" style="">
             ...
             <form  action="{{url('/load_legacy')}}" enctype="multipart/form-data" id="form" accept-charset="utf-8" method="post" name="applicationForm"  v-form>
