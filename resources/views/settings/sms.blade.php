...
@endif
 ...
 <h5 class="uk-heading_c">SMS Sent logs</h5>  
 <div style="">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="">
                                            <td> {{ $data->perPage()*($data->currentPage()-1)+($index+1) }} </td>
                                              <td> {{ @$row->student->INDEXNO }}</td>
                                               <td> <img class="md-user-image" style=" auto" src='{{url("public/albums/students/$row->student->INDEXNO.jpg")}} 'alt="Photo"    /></td>
                                           
                                            <td> {{ @$row->student->NAME }}</td>
                                             <td> {{ @$row->student->LEVEL }}</td>
                                            <td>{!! @$row->student->program->PROGRAMME!!}</td>
