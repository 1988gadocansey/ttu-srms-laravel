...
@endif
 ...
 <table class="uk-table-striped">
     ...
     <form method="POST" action="{{ url('uploadStaff') }}"  enctype="multipart/form-data"  accept-charset="utf-8"  name="applicationForm"  v-form>
         ...
         <div class="uk-width-small-1-2">
                 ...
                 <div class="md-card">
                     <div class="md-card-content">
                         <h3 class="heading_a uk-margin-small-bottom">
                            Upload Staff file here  Max size (2MB - .csv format only)
                         </h3>
          ...
          <p>click to download staff template(PLEASE ADHERE TO THE TEMPLATE)<a href='{{url("public/uploads/staff.csv")}}' download="teaching_staff.csv">click download template</a></p>
     </form>
 </div>
