                        ...
                        <div class="content" id="regular">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                               <centerd><b><p class="">OFFER OF ADMISSION  -
                                             ...
                                             {{ strtoupper(@$data->admitedProgram->PROGRAMME ."-"."SCHOOL OF GRADUATE STUDIES")}}  ADMISSION N<u>O </u>: {{$data->APPLICATION_NUMBER}}</p></b></center>
                                ...
                                <p>2. The<b> {{$year}} academic year</b> is scheduled to begin on <b> Monday 28th August   {{date('Y')}}</b>.You are to discuss your thesis proposal with the head of your department within sixty(60) days upon resumption of the academic session. You are expected to report for medical examination and registration from <b>Monday 28th August {{date('Y')}} to Friday 8th September  {{date('Y')}}</b>.You are mandated to participate in orientation programme which will run from <b>Monday 4th September to Friday 8th September {{date('Y')}}</b>.</p>
