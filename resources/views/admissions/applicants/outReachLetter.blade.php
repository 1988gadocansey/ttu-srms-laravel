    ...
    <div class="row">
        ...
        <div id='print'>
            <div id='page1'>
                            ...
                            <tr>
                                ...
                                <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>
                                      <img   style="width:106px;height: auto;margin-left: -3px;    margin-top: -34px; "  <?php
                                        $pic = $data->applicationNumber;
                                        echo $sys->picture("{!! url(\"public/albums/applicants/$pic.jpg\") !!}", 90)
                                        ?>  src="http://application.ttuportal.com/public/uploads/photos/{{$data->applicationNumber}}.jpg"alt="photo"     />
                        ...
                        @if($data->admissionType=='technical')
                        
                        <div class="content" id="technical">  <div class="watermark">
                             <div style="margin-left: 10px">
                                 <p style="text-transform: capitalize">DEAR <span style="text-transform: capitalize">{{$data->name}}</span></p>
                           
                            <div style="margin-left: 0px;text-align: justify">
                               
                                <centerd><b><p class="">OFFER OF ADMISSION  - {{ strtoupper(@$data->admitedProgram->department->schools->FACULTY)}}  -  ADMISSION N<u>O </u>: {{$data->applicationNumber}}</p></b></center>
                                <hr>
                       ...
                       @if(0===strpos($data->programmeAdmitted,'B'))
                                   @elseif(0===strpos($data->programmeAdmitted,'C') || 0===strpos($data->programmeAdmitted,'A'))
                                   Certificate,
                                      @elseif(0===strpos($data->programmeAdmitted,'H'))
                                    
                                       @elseif(0===strpos($data->programmeAdmitted,'D'))
                                       Diploma,
                                      @else
                                      @endif<b> {{$sys->getProgram($data->programmeAdmitted)}}</b>. The duration of the programme is {{$sys->getProgramDuration($data->programmeAdmitted)}} Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                          ...
                          @if($data->residentialStatus==0) 
                            <p>10. You are affiliated to<b> {{strtoupper($data->hallAdmitted)}} Hall. </b></p>
                          
                           @else
                           <p>10. You have been given Hall Accommodation at<b> {{strtoupper($data->hallAdmitted)}} Hall </b>. You will be required to make payment of  GHS{{$sys->hallFees($data->hallAdmitted)}} into any branch of Zenith Bank Ghana with account number  {{$sys->hallAccount($data->hallAdmitted)}}. <b/>You shall report to your assigned hall of residence with the original copy of pay-in-slip
                        ...
                        @elseif($data->admissionType=='provisional')
                        ...
                        <div class="content" id="conditional">  <div class="watermark">
                          ...
                          @elseif($data->admissionType=='regular' || $data->admissionType=='mature')
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of
                                   ...
                                   Certificate,
                                      ...
                                      @else
                                      @endif
                                    <b> {{$sys->getProgram($data->programmeAdmitted)}}</b>. The duration of the programme is {{$sys->getProgramDuration($data->programmeAdmitted)}} Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                ...
                                <p>2. The<b> {{$year}} academic year</b> is scheduled to begin on <b> Monday 28th August   {{date('Y')}}</b>. You are expected to report for medical examination and registration from <b>Monday 28th August {{date('Y')}} to Friday 8th September  {{date('Y')}}</b>.You are mandated to participate in orientation programme which will run from <b>Monday 4th September to Friday 8th September {{date('Y')}}</b>.</p>
                                 ...
                                 <p>3. You are required to make <b>PROVISIONAL PAYMENT</b> 
                                     of <b>GHS{{ $data->admissionFees}}</b> at any branch of 
                                     @if($data->admitedProgram->TYPE=="NON TERTIARY")
                                     <b> UNIBANK into Account Number   1570105703613</b>. If you do not indicate acceptance by paying the fees before <b> Monday 28th August,{{date('Y')}}</b> your place will be offered to another applicant on the waiting list. You are advised to make photocopy of the Pay-in-slip for keeps and present the original to the School Accounts Office on arrival.Indicate your admission number and programme of study on the Pay-in-slip. Any Applicant who fails to make <b>PROVISIONAL PAYMENT</b> of fees forfeits his/her admission. <b>Note: Fee payment is for an Academic Year and non-refundable and non-refundable</b>.</p>
                                        @elseif(0===strpos($data->programmeAdmitted,'B'))
