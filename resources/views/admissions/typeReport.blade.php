...
<h5 class="heading_c uk-margin-bottom">Admission Type Statistics</h5>
 ...
 <div class="md-card-content">
     ...
     <div class="uk-overflow-container" id='print'>
          <center><span class="uk-text-success uk-text-bold"><?php echo count($data)?> Records</span></center>
        
                 <table border="1" class="uk-table uk-table-hover uk-table-align-vertical "  > 
                                  <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td  @if($row->ID % 2 == 0 )class='md-bg-purple-100 uk-text-small'@else class='md-bg-cyan-100 uk-text-small' @endif >{{strtoupper($row->ADMISSION_TYPE)}}</td>
                                         <td>{{$sys->getApplicantTotalPerProgramAdmissionType($row->ADMISSION_TYPE)}}<?php $total[] = $sys->getApplicantTotalPerProgramAdmissionType($row->ADMISSION_TYPE); ?></td>
                                     </tr>
                                      
                                        @endforeach
                                         <tr><td class='md-bg-purple uk-text-small'>Total</td>
                                             <td class="uk-text-bold uk-text-success">{{@array_sum($total)}}</td></tr>
