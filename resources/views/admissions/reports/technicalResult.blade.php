...
@section('content')
    ...
    @if (count($errors) > 0)
        ...
        <h5 class="heading_c uk-margin-bottom">TECHNICAL ADMISSIONS EXAM RESULTS</h5>
                ...
                <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}">
                    ...
                    <div class="uk-dropdown">
                        <ul class="uk-nav uk-nav-dropdown">
                            <li><a href="#" onClick ="$('#mature').tableExport({type:'csv',escape:'false'});"><img src='{!! url("public/assets/icons/csv.png")!!}' width="24"/> CSV</a></li>
                    ...
                    <div class="uk-overflow-container" id='print'>
                        ...
                        <!--                                            <th>TOTAL </th>-->
                            ...
                            @foreach($data as $index=> $row)
                                ...
                                <td class=' '><?php  if(!empty($sys->getSittingGrade($row->APPLICATION_NUMBER,'FIRST SITTING'))){print_r($sys->getSittingGrade($row->APPLICATION_NUMBER,'FIRST SITTING'));}?></td>
                                ...
                                <td class=' '><?php if(!empty($sys->getSittingGrade($row->APPLICATION_NUMBER,'THIRD SITTING'))){print_r ($sys->getSittingGrade($row->APPLICATION_NUMBER,'THIRD SITTING'));}?> </td>
                                </tr>
