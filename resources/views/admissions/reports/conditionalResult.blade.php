...
@section('content')
    ...
    @if (count($errors) > 0)
        ...
        <h5 class="heading_c uk-margin-bottom">CONDITIONAL ADMISSIONS EXAM RESULTS</h5>
                ...
                <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}">
                    ...
                    <div class="uk-dropdown">
                        <ul class="uk-nav uk-nav-dropdown">
                            <li><a href="#" onClick ="$('#conditional').tableExport({type:'csv',escape:'false'});"><img src='{!! url("public/assets/icons/csv.png")!!}' width="24"/> CSV</a></li>
