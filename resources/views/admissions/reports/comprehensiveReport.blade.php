                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                        <td> {{ $programcode->perPage()*($programcode->currentPage()-1)+($index+1) }} </td>
                                         ...
                                         <td class='md-bg-grey-100 uk-text-small'>{{$sys->allApplicantsChoice1($row->PROGRAMMECODE)}}<?php $total1c[] = $sys->allApplicantsChoice1($row->PROGRAMMECODE) ?></td>
                                          <td class='md-bg-grey-100 uk-text-small'>{{$sys->allApplicantsChoice2($row->PROGRAMMECODE,"FEMALE")}}<?php $total2c[] = $sys->allApplicantsChoice2($row->PROGRAMMECODE,"FEMALE") ?></td>
                                         <td class='md-bg-cyan-100 uk-text-small'>{{$sys->allApplicantsChoice3($row->PROGRAMMECODE)}}<?php $total3c[] = $sys->allApplicantsChoice3($row->PROGRAMMECODE) ?></td>
                                          <td class='md-bg-grey-100 uk-text-small'>{{$sys->getApplicantTotalPerProgram($row->PROGRAMMECODE,"MALE")}}<?php $totalad[] = $sys->getApplicantTotalPerProgram($row->PROGRAMMECODE,"MALE") ?></td>
                                          <td class='md-bg-grey-100 uk-text-small'>{{$sys->getTotalRegistered100($row->PROGRAMMECODE)}}<?php $totalrg[] = $sys->getTotalRegistered100($row->PROGRAMMECODE) ?>
                                          </td>
