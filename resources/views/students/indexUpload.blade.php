...
@if(Session::has('success'))
 ...
 <div align="center">
                 ...
                 <div class="md-card">
                     <div class="md-card-content">
                         <h3 class="heading_a uk-margin-small-bottom">
                            Upload student index number file here  Max size - Excel file formats only (10MB)
                         </h3>
     ...
     <p>click to download course template(PLEASE ADHERE TO THE TEMPLATE)<a href='{{url("public/uploads/index.xlsx")}}' download="students.xlsx">click download template</a></p>
...
@section('js')
 <script>
       ...
       UIkit.modal.alert('uploading students index number ...');
