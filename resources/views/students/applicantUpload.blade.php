...
@if(Session::has('success'))
 ...
 <div align="center">
     <form method="POST" enctype="multipart/form-data"  accept-charset="utf-8"  name="applicationForm"  v-form>
                 ...
                 <div class="md-card">
                     <div class="md-card-content">
                         <h3 class="heading_a uk-margin-small-bottom">
                            Upload Applicants data here  Max size - Excel file formats only(10MB)
                         </h3>
      ...
      <p>click to download course template(PLEASE ADHERE TO THE TEMPLATE)<a href='{{url("public/uploads/level 100.xlsx")}}' download="level 100.xlsx">click download template</a></p>
...
@section('js')
 <script>
       ...
       UIkit.modal.alert('Uploading Admitted Applicants Data...');
