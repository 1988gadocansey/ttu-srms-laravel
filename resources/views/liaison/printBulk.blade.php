...
{{--{{dd($datas)}}--}}
                ...
                <div class="invoice-address">
                    <div class="row">
                        <div class="col-md-5 col-sm-5">
                            ...
                            <div style='float:right;text-align:right; pluck;'>
                                <b><?php echo strtoupper(date('jS F, Y'));  ?> </b></div>
                            <!-- <br> -->

                            <p class="address" style="line-break: auto"><?php echo strtoupper(@$data->addressDetails->addresses); ?>
                ...
                <div id='letter'><br>
                    <div style='text-align:left; pluck;'>Dear Sir/Madam,</div>


                    <!--  BEGIN THE REST HERE  -->

                    <center><p style=";" class=" "><h5>PRACTICAL INDUSTRIAL TRAINING PROGRAMME FOR STUDENTS</h5>
                    </center>
                    <p style='text-align:justify; pluck;'>Students of Takoradi Technical University pursuing Higher
                        National Diploma (HND)<?php //echo $help->getProgram($person[PROGRAMME]);?> are expected to
                        undergo practical industrial training in industry as part of the requirements for the award of
                        their certificate.</p>
                    ...
                    <p style='text-align:justify; pluck;'>
                        ...
                        themselves with current technological development in industry and commerce.</p>
                    <p style='text-align:justify; pluck;'>The University would, therefore, be grateful if you could
                        consider the under-mentioned student to undertake his/her industrial attachment programme in
                        your organization from <b>3rd June - 10th August, 2019</b>.</p>
                    ...
                    <p><b>REGISTRATION NUMBER:</b> <?php echo $data->studentDetials->INDEXNO;?> <br/>
                        ...
                        <b>PROGRAMME: </b> <?php echo strtoupper(@$data->studentDetials->program->PROGRAMME) . "  " . $studentLevel;?>
                        <br/>
                        <b>CONTACT NUMBER:</b> <?php echo @$data->studentDetials->TELEPHONENO;?><br/></p>


                    <p style='text-align:justify;  '>We request that the student should be made to familiarize
                        him/herself with all the related sections available in your organization.
                        For your information, all students at the University are covered by Group Personal Accident
                        Insurance policy.</p>
                    ...
                    <div style='float:left;font-weight: normal;'>
                        ...
                        <small><b>NB: DO NOT ACCEPT THIS LETTER IF IT DOES NOT BEAR THE ORIGINAL SIGNATURE AND STAMP</b>
                        </small>
                    </div>
