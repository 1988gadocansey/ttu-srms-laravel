...
@endif
 ...
 <div class="md-card">
     <div class="md-card-content"  >
         ...
         <h5 class=" ">Create Payment Types here</h5>
               ...
               <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-2">
                            <div class="uk-form-row">
                                ...
                                <label>Level</label>
                                <p></p>
                                {{ Form::select('level', array(''=>'select level','All'=>'All','50'=>'50', '100'=>'1st year','200'=>'2nd year','300'=>'3rd year','400'=>'4th year'), null, ["required"=>"required",'class' => 'md-input','v-model'=>'level','v-form-ctrl'=>'','v-select'=>'']) }}
