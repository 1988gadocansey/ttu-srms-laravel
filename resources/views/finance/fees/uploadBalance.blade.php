...
@if(Session::has('success'))
 ...
 <div align="center">
     <form method="POST"    enctype="multipart/form-data"  accept-charset="utf-8"  name="applicationForm"  v-form>
                 ...
                 <div class="md-card">
                     <div class="md-card-content">
                         <h3 class="heading_a uk-margin-small-bottom">
                            Upload students payments balances file. Excel format only.  
                         </h3>
                         </h3>
         ...
         <p>click to download fee template(PLEASE ADHERE TO THE TEMPLATE)<a href='{{url("public/uploads/finance.xlsx")}}' download="finance.xlsx">click download template</a></p>
     </form>
 </div>
...
@section('js')
 <script>
       ...
       UIkit.modal.alert('uploading balances...');
