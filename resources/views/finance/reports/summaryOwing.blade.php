...
<h5 class="heading_c uk-margin-bottom">Fee Owings by Programs Summary Statistics</h5>
...
<!--                                            <th>TOTAL </th>-->
                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td  @if($row->ID % 2 == 0 )class='md-bg-purple-100 uk-text-small'@else class='md-bg-cyan-100 uk-text-small' @endif >{{$row->PROGRAMME}}</td>
                                         <td class='md-bg-grey-100 uk-text-small'>{{$sys->getStudentsTotalPerProgram($row->PROGRAMMECODE)}}<?php $total[] = $sys->getStudentsTotalPerProgram($row->PROGRAMMECODE) ?></td>
                                        
                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'100')}}   <?php $a[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '100') ?></td>
                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'200')}}<?php $b[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '200') ?></td>
                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'300')}}<?php $c[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '300') ?></td>
                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'400')}}<?php $d[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '400') ?></td>

                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'400/1')}}<?php $e[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '400/1') ?></td>
                                         <td class='md-bg-purple-100 uk-text-small'>{{$sys->getTotalOwingbyProgram($row->PROGRAMMECODE,'400/2')}}<?php $f[] = $sys->getTotalOwingbyProgram($row->PROGRAMMECODE, '400/2') ?></td>
