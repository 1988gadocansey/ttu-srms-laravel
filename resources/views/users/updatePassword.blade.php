...
@endif
     ...
     <div class="uk-width-large-8-10" style="margin-left: 100px">
         <h3 class="heading_c uk-margin-bottom">Update Password</h3>
         
         <div class="md-card">
             <div class="md-card-content">
                
                 <form action="{{url('admin/update/phone')}}" method="post" class="form-horizontal row-border"   id="form" data-validate="parsley" >
                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                     <div class="uk-grid" data-uk-grid-margin="">
                         
                        <div class="uk-width-medium-3-10">
                            <label for="product_search_price">id</label>
                            <input  type="text" class="md-input" name="id" required="" maxlength="10"     >
                        </div>
